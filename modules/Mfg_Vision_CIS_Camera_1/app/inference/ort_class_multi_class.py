...
class ONNXRuntimeClassificationMultiClass():
    ...
    def __init__(self, model_path, classes, target_dim, target_prob):
...
def initialize_class_multi_class(model_path, labels_path, target_dim, target_prob):
    ...
    print('Loading model...\n', end='')
    global ort_model
    ort_model = ONNXRuntimeClassificationMultiClass(model_path, classes, target_dim, target_prob)
    print('Success!')
